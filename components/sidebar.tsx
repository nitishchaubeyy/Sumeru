...
export function Sidebar({ user }: { user: any }) {
  ...
  const menuItems = [
    ...
    { name: "Sankalp Tracker", href: "/dashboard/sankalp", icon: Home, disabled: true },
    { name: "My Profile", href: "/dashboard/profile", icon: UserIcon, disabled: true },
  ];
  ...
  return (
    <aside className="w-64 bg-white dark:bg-zinc-950 border-r border-orange-100 dark:border-zinc-800 flex flex-col h-screen sticky top-0 transition-colors duration-300">
      {/* --- App Brand --- */}
      <div className="p-8">
        <h1 className="text-2xl font-black text-brand-orange tracking-tighter">SUMERU</h1>
      </div>
